...
import type { VoteSubmissionDto } from "../shared/services/voteSubmissionService";
...
// const SubmissionRow: React.FC<{ submission: VoteSubmissionDto }> = ({
//   submission,
// }) => {
//   const submittedAt = submission.submissionTime
//     ? new Date(submission.submissionTime).toLocaleString()
