...
//         ...s,
//         loading: false,
//         error: "Missing org context. Please select an organization (org_id).",
//       }));
//       return;
//     }
...
//     (async () => {
//       try {
//         const dto = await http.get<UserDto>("/api/users/me");

//         // Tenant type source:
//         // ✅ Best: backend includes tenantType in UserDto
//         // Fallback: treat orgName/orgId as ORG unless you manually mark NEC
//         const tenantType: "NEC" | "ORG" =
//           dto.tenantType === "NEC" ? "NEC" : "ORG";

//         const tenant: TenantInfo = {
//           orgId: dto.orgId ?? orgId,
//           orgName:
//             dto.orgName ?? (tenantType === "NEC" ? "NEC" : "Organization"),
//           tenantType,
//         };

//         const dashboardMode = computeDashboardMode(dto, tenantType);
//         const capabilities = computeCapabilities(dto, tenantType);
