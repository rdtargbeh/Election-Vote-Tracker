...
//  *  - attaches X-Org-Id header only if currentOrgId exists
//  *  - normalizes errors to ApiError
//  *  - detects HTML responses (Vite index.html / login page / error page)
//  *  - clears auth + redirects to /login on 401
//  */
...
// /**
//  * Backend mounted at /api
//  * Service URLs should NOT repeat /api
//  */
// const API_BASE_URL =
//   import.meta.env.VITE_API_BASE_URL ?? "http://localhost:8080/api";
...
// /**
//  * IMPORTANT:
//  * Your ApiError.details appears to be: Record<string, string | string[]>
//  * So we must NEVER put undefined values in details.
//  */
// function buildDetails(params: {
//   url?: string;
//   method?: string;
...
//     // Keep your existing server error shape mapping
//     return {
//       status,
//       code: anyData.code ?? anyData.errorCode ?? undefined,
//       message:
