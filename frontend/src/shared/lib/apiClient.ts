...
//     // If you do this here, it can cause navigation loops if your router is also redirecting.
//     // I recommend handling 401 in your UI (RequireAuth / error boundaries) unless you’re sure.
//     //
//     // if (apiErr.status === 401) {
