...
//   // If backend already gives guidance, don't repeat it.
//   if (
//     m.includes("contact") &&
...
//   // For your common cases, backend message already explains the issue
...
//         // Your ApiError shape: { status, error, message, path, rid, fieldErrors }
//         const msg =
//           data?.message ||
//           data?.detail ||
//           data?.error ||
