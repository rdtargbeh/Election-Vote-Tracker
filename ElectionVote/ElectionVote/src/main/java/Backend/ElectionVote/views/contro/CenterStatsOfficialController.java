...
/**
 * Public controller for NEC official center stats (published NEC results).
 * Endpoint: GET /api/stats/official/centers
 */
@RestController
@RequestMapping("/api/stats/official/centers")
@RequiredArgsConstructor
@Validated
public class CenterStatsOfficialController {

    private static final Logger log = LoggerFactory.getLogger(CenterStatsOfficialController.class);

    private final CenterStatsOfficialService service;
