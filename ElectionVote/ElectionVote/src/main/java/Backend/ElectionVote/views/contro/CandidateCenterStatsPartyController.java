...
/**
 * Controller exposing candidate-level per-center stats from v_candidate_center_stats_party.
 * Endpoint: GET /api/stats/party/candidates/centers
 */
@RestController
@RequestMapping("/api/stats/party/candidates/centers")
