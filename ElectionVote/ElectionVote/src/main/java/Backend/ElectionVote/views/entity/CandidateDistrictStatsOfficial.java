...
/**
 * Read-only mapping of v_candidate_district_stats_official.
 */
@Entity
@Table(name = "v_candidate_district_stats_official")
@Immutable
@Getter
@NoArgsConstructor
public class CandidateDistrictStatsOfficial {

    @EmbeddedId
    private CandidateDistrictStatsOfficialId id;
