...
/**
 * Controller exposing NEC official candidate-level election stats.
 * Endpoint: GET /api/stats/official/candidates/elections
 */
@RestController
@RequestMapping("/api/stats/official/candidates/elections")
@RequiredArgsConstructor
@Validated
public class CandidateElectionStatsOfficialController {

    private static final Logger log = LoggerFactory.getLogger(CandidateElectionStatsOfficialController.class);

    private final CandidateElectionStatsOfficialService service;
    ...
    public ResponseEntity<Page<CandidateElectionStatsOfficialDto>> list(
        ...
        log.debug("Controller list official candidate election stats electionId={} candidateId={} partyId={} page={} size={} sort={}",
                electionId, candidateId, partyId, page, pageSize, sortObj);
