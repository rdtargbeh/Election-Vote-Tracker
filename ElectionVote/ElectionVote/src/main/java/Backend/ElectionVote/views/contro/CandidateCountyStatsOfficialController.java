...
/**
 * Controller exposing NEC official candidate-level county stats.
 * Endpoint: GET /api/stats/official/candidates/counties
 */
@RestController
@RequestMapping("/api/stats/official/candidates/counties")
@RequiredArgsConstructor
@Validated
public class CandidateCountyStatsOfficialController {

    private static final Logger log = LoggerFactory.getLogger(CandidateCountyStatsOfficialController.class);

    private final CandidateCountyStatsOfficialService service;
