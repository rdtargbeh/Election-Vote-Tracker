...
import Backend.ElectionVote.mapper.ElectionPartyMapper;
import Backend.ElectionVote.repository.ElectionPartyRepository;
...
public class ElectionPartyServiceImplementation implements ElectionPartyService {
    ...
    public void removePartyFromElection(UUID electionId, UUID partyId) {
        var id = new Backend.ElectionVote.utility.ElectionPartyId(electionId, partyId);
