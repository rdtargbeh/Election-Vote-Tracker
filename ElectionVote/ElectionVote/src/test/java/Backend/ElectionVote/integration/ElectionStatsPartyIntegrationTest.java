...
import Backend.ElectionVote.views.repo.ElectionStatsPartyRepository;
...
/**
 * Integration test skeleton for election-level stats.
 * Place under src/test/java and provide test migrations to exercise view SQL if full end-to-end verification is desired.
 */
@SpringBootTest
@ActiveProfiles("test")
@Testcontainers
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class ElectionStatsPartyIntegrationTest {
    ...
    @Autowired
    private ElectionStatsPartyRepository repo;
